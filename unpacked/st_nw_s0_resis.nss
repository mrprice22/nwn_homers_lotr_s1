...
December 2002
File: st_nw_s0_resis
Purpose: Example spell converted to use tracking.  This is
         the spell Resistence.  You must rename this spell
         to nw_s0_resis for it to take effect.
         Each spell should start:
