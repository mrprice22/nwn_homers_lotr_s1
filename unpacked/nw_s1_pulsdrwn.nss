...
/*
    ...
    Module override: the self-damage above was written for
    elemental casters only, but this ability is granted to several
    non-elemental NPCs (e.g. the High Wizard of Gondor, Boromir),
    who were bleeding half their current HP to themselves on every
    cast. Gate the self-damage to actual elementals to match the
    original intent.
*/
//:://////////////////////////////////////////////
...
void main ()
{
    if (GetRacialType(OBJECT_SELF) == RACIAL_TYPE_ELEMENTAL)
    {
