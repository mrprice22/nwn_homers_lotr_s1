...
SpeakString("Minas Tirith is under attack! Rally Free People of Middle Earth to The White City!", TALKVOLUME_SHOUT);
object oSpawnMaster;
...
fSpawnTime = StringToFloat( GetSubString(szSpawnPointInfo, 0, 3) + ".2" );
