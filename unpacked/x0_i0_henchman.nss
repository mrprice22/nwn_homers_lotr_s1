...
void HireHenchman(object oPC, object oHench=OBJECT_SELF, int bAdd=TRUE)
{
    ...
    object oFormerHench = GetHenchman(oPC);
    ...
    if (bAdd == TRUE)
    {
        ...
        AssignCommand(oHench, LevelUpXP1Henchman(oPC));
    }
...
void LevelHenchmanUpTo(object oHenchman, int nLevel, int nClass2=CLASS_TYPE_INVALID, int nMaxLevelInSecondClass=0)
{
    ...
    while ( (nLevel1 + nLevel2) < nLevel )
    {
        ...
        // * Additional Rules
        // * The player can choose a levelup strategy for the henchman
...
void LevelUpXP1Henchman(object oPC)
{
    ...
    {
        SendMessageToPC(GetFirstPC(),"Leveling up Kama");
