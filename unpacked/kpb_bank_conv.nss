void main()
{
    ...
    if(nConversation == 20)
    {
        ...
        if(nGold > nGoldHeld)
            ...
            {
            SpeakString("You can't deposit zero gold... we don't have the forms for such things!");
            }
    ...
    if(nConversation == 21)
    {
        ...
        if(nGold <= 0)
            {
            SpeakString("What?!  Do not waste me time, arg!");
            }
        ...
        else
        {
            int nAmount = (nBalance - nGold);
            SetCampaignInt("kpb_bank", "KPB_BANK_BALANCE", nAmount, oPC);
            SpeakString("I got your stuff right here.  Have a nice day.");
