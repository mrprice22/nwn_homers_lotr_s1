/*
    ...
    June 6, 2004: Adding variable to Bio's anim script.
*/

// Maximum float distance of NW_STOP waypoint before it becomes invalid
float fNWStopDistance = IntToFloat(GetLocalInt(OBJECT_SELF, "TOA_INT_STOP_DISTANCE"));
...
void AnimActionPlayRandomMobile()
{
    ...
    if (nRoll < 5) {
        ...
        if (AnimActionGoToStop(fNWStopDistance))
            return;
