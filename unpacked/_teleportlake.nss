...
effect eAppear1 = EffectDisappear(VFX_FNF_LOS_HOLY_30);
effect eVis1 = EffectVisualEffect(VFX_FNF_SUMMONDRAGON );
...
DelayCommand(1.0,AssignCommand (oPC, ActionJumpToObject(GetWaypointByTag("laketwonenter"))));
}
